...
def test_all_catalog_boundaries_have_named_real_runtime_callsites() -> None:
    expected = {
        ...
        "callback_transport_interruption": ("service.py", "_deliver_callback_record_parallel"),
        ...
        "expired_sender_lease_race": ("service.py", "_deliver_callback_record_parallel"),
        "duplicate_callback_replay": ("service.py", "_deliver_callback_record_parallel"),
